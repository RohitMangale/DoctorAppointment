...
const Profile = ({ doctorData }) => {
  ...
  // --------------------------------------------------------------------Qualifications----------------------------------------
  // add qualifications function
  const addQualification = e => {
    e.preventDefault();

    addItem("qualifications", {
      startingDate: " ", endingDate: " ", degree: "Phd", university: "MU",
    });
  };
  ...
  // delete qualifications function
  ...
  const addTimeSlot = e => {
    ...
    addItem("timeSlots", {
      day: "Sunday", startingTime: "10:00", endingTime: "10:30",
    });
  };
