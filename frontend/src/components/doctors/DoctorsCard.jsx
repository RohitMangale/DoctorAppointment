    ...
    return (
        <div className="p-3 lg:p-5">
            <div className=" w-full h-[400px]   rounded-[12px] ">
                <img src={photo} className="w-full h-full rounded-[12px] object-cover object-top " alt="" />
            </div>
            ...
            <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E]  items-center flex justify-center group hover:bg-primaryColor hover:border-none"
                >
