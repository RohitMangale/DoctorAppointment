          ...
          {qualifications?.map((item, index) => (
            <li key={index} className="flex flex-col sm:flex-row sm: justify-between sm:items-end md:gap-5 mb-[30px] ">
              <div>
                ...
                <p className="text-[16px] leading-6 font-medium  text-textColor">PHD in {item.degree}
                </p>
              </div>
              <p className="text-[14px] leading-5 font-medium text-textColor"> New Apollo {item.university}
              </p>
            </li>
          )
          )}
